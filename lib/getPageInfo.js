...
module.exports = async function() {
    ...
    if(!element) {
        ...
        */
        res = await this.instance.selectorExecute(element, function(elem) {
    ...
    if (!this.currentArgs.exclude) {
        this.currentArgs.exclude = [];
    } else if (!(this.currentArgs.exclude instanceof Array)) {
        this.currentArgs.exclude = [this.currentArgs.exclude];
    }

    this.currentArgs.exclude.forEach(function(excludeElement) {
    ...
    excludeElements = await this.instance.selectorExecute(excludeElements, function() {
        /**
