 ...
 */
var modifyElements = async function(elements, style, value) {
    if(elements.length === 0) {
        return;
    }

    await this.instance.selectorExecute(elements, function() {
...
module.exports = async function() {
     ...
     */
    await modifyElements.call(this, hiddenElements, 'visibility', 'hidden');
    await modifyElements.call(this, removeElements, 'display', 'none');

    /**
     * take 100ms pause to give browser time for rendering
     */
    await this.instance.pause(100).saveDocumentScreenshot(this.screenshot)

    /**
     * make hidden elements visible again
     */
    await modifyElements.call(this, hiddenElements, 'visibility', '');
    await modifyElements.call(this, removeElements, 'display', '');
};
